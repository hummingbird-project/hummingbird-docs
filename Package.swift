...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/hummingbird-project/hummingbird-auth.git", branch: "1.x.x"),
        .package(url: "https://github.com/hummingbird-project/hummingbird-compression.git", branch: "1.x.x"),
        .package(url: "https://github.com/hummingbird-project/hummingbird-fluent.git", branch: "1.x.x"),
        .package(url: "https://github.com/hummingbird-project/hummingbird-lambda.git", branch: "1.x.x"),
        .package(url: "https://github.com/hummingbird-project/hummingbird-mustache.git", branch: "1.x.x"),
        .package(url: "https://github.com/hummingbird-project/hummingbird-redis.git", branch: "1.x.x"),
