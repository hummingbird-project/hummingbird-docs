...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/hummingbird-project/swift-jobs-postgres.git", branch: "job-service"),
        .package(url: "https://github.com/hummingbird-project/swift-jobs-valkey.git", branch: "job-service"),
        ...
        .package(url: "https://github.com/hummingbird-project/hummingbird-valkey.git", from: "1.0.0"),
